...
void main() => runApp(const PetraBallon());
      ...
      home: Scaffold(
        ...
        body: Builder(
          builder: (BuildContext context) {
            ...
            print(ticket.ticketNumber); // Output: 6967024
            print(ticket.passenger); // Output: adult
            print(ticket.date); // Output: 2023-07-10 17:55:12.000
